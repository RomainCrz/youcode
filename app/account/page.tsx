        ...
        <Card className="m-auto max-w-lg mt-4">
            <CardHeader className="flex flex-row space-y-0 gap-4">
                <Avatar>
                    ...
                    {session.user.image && (
                        <AvatarImage src={session.user.image} alt={'avatar picture'} />
                    )}
                </Avatar>
            ...
            <CardContent className="flex flex-col gap-2">
                <Link className={buttonVariants({variant:"outline", size: "lg"})} href="/account/settings">Settings</Link>
                <Link className={buttonVariants({variant:"outline", size: "lg"})} href="/admin">Admin</Link>
            </CardContent>
